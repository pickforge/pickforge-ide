# PickForge Brand Assets

PickForge uses the Pickforge Studio v2 visual system: dark canvas, off-white selection bracket, and one ember accent.

## Source

These files are exported from `branding-visual/assets/pickforge/`.
...
- `pickforge-og-image.png` and `pickforge-og-image.svg` are social card exports.

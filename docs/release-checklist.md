...
- [x] Linux release signing secret is configured or the unsigned-release decision is explicitly approved. Unsigned v0.1.0 approved by the owner (2026-07-02); updater artifacts are minisign-signed.

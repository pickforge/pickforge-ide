...
/// Shared by every Android-backed target (React Native, native Android).
enum AndroidA11yRole {
  button,
  text,
  image,
  input,
...
class AndroidA11yNode extends Equatable {
  const AndroidA11yNode({
  ...
  final bool selected;
  final List<AndroidA11yNode> children;

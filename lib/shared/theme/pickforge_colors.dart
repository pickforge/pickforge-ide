...
class PickforgeColors {
  ...
  // ── Surfaces (the canvas) ────────────────────────────────────────────────
  // Cold near-blacks straight from DESIGN-TOKENS.md: the cinematic canvas
  // that makes the single ember read as fire.
  /// Base page background. The brand black (`--color-surface`).
